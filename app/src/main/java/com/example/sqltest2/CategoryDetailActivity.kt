...
class CategoryDetailActivity : AppCompatActivity() {
    ...
    private var articleIsNull = true
    private lateinit var NoArticle: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        NoArticle = findViewById(R.id.NoArticle)
        ...
        categoryAliasTextView.text = "$categoryAlias"
        ...
        articleAdapter = ArticleAdapter(articles, articleIsNull)
    ...
    private fun loadArticlesForCategory(categoryId: Int) {
        CoroutineScope(Dispatchers.Main).launch {
            ...
            if (error != null) {
                ...
                // 根据 articleList 是否为空来修改 articleIsNull
                articleIsNull = articles.isEmpty()
                if(articleIsNull == true){
